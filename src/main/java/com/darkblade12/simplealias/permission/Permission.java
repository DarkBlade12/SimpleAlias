...
public enum Permission {
	...
	SET_COMMAND("SimpleAlias.set"),
	ADD_COMMAND("SimpleAlias.add"),
	CREATE_ACTION_COMMAND("SimpleAlias.action.create"),
	REMOVE_ACTION_COMMAND("SimpleAlias.action.remove"),
	SET_ACTION_COMMAND("SimpleAlias.action.set"),
	ADD_ACTION_COMMAND("SimpleAlias.action.add"),
	...
	BYPASS_DELAY("SimpleAlias.bypass.delay"),
